...
export default function index({ address, direction, language, metaTags }: FaqData) {

    return (
        <FaqComponent address={address} direction={direction} language={language} isSSR={true} metaTags={metaTags}/>
    );
}
