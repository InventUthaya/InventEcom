...
public class LocateOurStoresEntityMapper : ITypeConverter<DBO.LocateOurStores, ViewEntities.LocateOurStores>
{
    public ViewEntities.LocateOurStores Convert(DBO.LocateOurStores source, ViewEntities.LocateOurStores destination, ResolutionContext context)
    {
        return new ViewEntities.LocateOurStores
        {
            Id = source?.Id ?? 0,
