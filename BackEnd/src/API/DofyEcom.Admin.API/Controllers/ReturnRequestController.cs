...
namespace DofyEcom.Admin.API.Controllers
{
    ...
    public class ReturnRequestController : ControllerBase
    {
        ...
        public IActionResult UpdateRefund([FromBody] RefundUpdate data)
        {
            var result = _returnsModel.UpdateRefund(data);
        ...
        [HttpPost("UpdateReplacement")]
        public IActionResult UpdateReplacement([FromBody] RefundUpdate data)
        {
            var result = _returnsModel.UpdateReplacement(data);
